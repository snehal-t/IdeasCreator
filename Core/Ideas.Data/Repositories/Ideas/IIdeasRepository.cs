...
namespace Ideas.Data.Repositories.Ideas
{
    public interface IIdeasRepository
    {
        ...
        InviteeList DeligateIdea(String ideaId, string assignee, string userComments, string email, string author);
        ...
        bool EditComment(string ideaId, string commentId, string email, string author, bool commentType, long commentParentId, string userComments);
        bool DeleteComment(string ideaId, string commentId, string email, string author);
